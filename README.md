...
Ce script a été développé pour un club sportif de 950 membres afin d'éliminer les saisies manuelles entre le fichier de suivi des factures et le budget analytique. Avant sa mise en place, les données étaient copiées-collées à la main chaque semaine dans des dizaines d'onglets différents.
